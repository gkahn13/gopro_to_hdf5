...
def equirectangular_to_fisheye(im_equi, size, **kwargs):
    ...
    im_fish_clip = im_fish_rect[225:-225,100:-100]
...
if __name__ == '__main__':
    ...
    im_equi = np_utils.imresize(im_equi, [500, 1000, 3])
    im_dualfish, remap, keep_mask = equirectangular_to_fisheye(im_equi, size=1000)
